...
![Original synthetic concept cover for JINGZHANG STRATA: a railway-heritage base, three light-coded fields, and reversible layered civic interfaces; not a site photograph, official rendering, or spatial evidence](assets/media/cover.webp)
...
![Three evidence chains: sources, air, and space](assets/figures/site-overview.en.png)
...
![Three-level framework and concept land-use structure](assets/figures/land-use-structure.en.png)
...
![Three fields and the S01–S12 relay](assets/figures/key-areas.en.png)
...
![Metrics, provenance, and recalculation status](assets/figures/metrics-evidence.en.png)
